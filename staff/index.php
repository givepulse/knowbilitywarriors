...
<main id="mainContent" role="main" tabindex="-1">
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Stephanie Thomas, President</h2>
            <p>
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Jennifer, McPhail, Vice President</h2>
            <p>
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Paul Hilgers, Secretary</h2>
            <p>
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Jean Langendorf, Treasurer</h2>
            <p>
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Dana Carpenter, Member</h2>
            <p>
            </p>
        </div>
    </div>
    <div class="clearfix" style="margin-top:1em;">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Becca Bruce Dobberfuhl, Member</h2>
            <p>
    ...
    <div class="clearfix">
        ...
        <div class="col-md-10">
            <h2 style="margin-top:0;">Isabelle Headrick, Executive Director</h2>
            <p>
