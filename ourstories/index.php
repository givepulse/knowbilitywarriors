...
<main id="mainContent" role="main" tabindex="-1">
    ...
    <div class="row clearfix" style="margin-bottom:4em;">
        <div class="col-md-4">
            <img src="../images/elainna.jpg" style="width:360px" class="img-rounded" alt="Elainna smiling in front of her house">
        </div>
        <div class="col-md-8">
    ...
    <div class="row clearfix" style="margin-bottom:4em;">
        <div class="col-md-4">
            <img src="../images/thompsons.jpg" style="width:360px" class="img-rounded" alt="Father with kids in front of house">
        </div>
