...
<main id="mainContent" role="main" tabindex="-1">
    ...
    <div class="row clearfix">
        <div class="col-md-6">
            <img src="../images/elainna.jpg" style="width:560px" class="img-rounded" alt="Young woman smiling">
        </div>
        <div class="col-md-5">
            <p class="lead">
    ...
    <div class="row clearfix">
        <div class="col-md-6">
            <img src="../images/thompsons.jpg" style="width:560px" class="img-rounded" alt="Father with kids in front of house">
        </div>
